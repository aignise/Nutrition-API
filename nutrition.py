...
def submit_tool_outputs(thread_id, run_id, run_status, user_query, diet, intolerances, maxCarbs, minProtein, maxFat, maxReadyTime):
    ...
    output = fetch_recipes(query=user_query, diet=diet, intolerances=intolerances, maxCarbs=maxCarbs, minProtein=minProtein, maxFat=maxFat, maxReadyTime=maxReadyTime)  # Fetch recipes based on user query
    output_str = ""
